    ...
    onAuthStateChanged(authInstance, async (user) => {
        ...
        try {
            ...
            console.log('🔐 [AUTH] State updated:', {
                loggedIn: window.__AUTH__.isLoggedIn,
                role: window.__AUTH__.role,
                name: window.__AUTH__.displayName,
                ready: window.__AUTH__.ready
            });
        }
    });
}
...
async function sendPasswordReset(email) {
    ...
    try {
        ...
        console.log('[AUTH] Password reset email sent to:', safeEmail);
        return { success: true, error: null };
    } catch (err) {
...
console.log('✅ [AUTH] OraaSlayer Auth Module v3.2 loaded successfully');
