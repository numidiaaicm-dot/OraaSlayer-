...
const AEGIS_CONFIG = Object.freeze({
    ...
    PAGE_SIZE: 20,
    SLIDER_COUNT: 5,
    CACHE_TIME: 7200000, // Increased to 2 hours
    SCROLL_THRESHOLD: 850,
    IMAGE_ROOT_MARGIN: '300px', // Reduced for faster loading
    SEARCH_DEBOUNCE_PC: 100, // Faster
    SEARCH_DEBOUNCE_MOBILE: 200,
    SUGGEST_DEBOUNCE_PC: 80, // Faster
    SUGGEST_DEBOUNCE_MOBILE: 150,
    SLIDER_INTERVAL: 5000,
    DIVERSITY_FACTOR: 0.25,
    DECAY_DAYS: 30,
    PREFETCH_MAX_IMAGES: 6, // More prefetch
    API_TIMEOUT: 8000, // Faster timeout
    SUGGESTION_CACHE_TTL: 300000, // Longer
    MIN_YEAR: 2023,
    SESSION_SEED: Math.random() * 9999,
    WRITE_FRAME_BUDGET: 12, // More frames
